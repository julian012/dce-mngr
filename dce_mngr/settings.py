"""
Django settings for dce_mngr project.
...
SECRET_KEY = 'django-insecure-31ckxy7h!i!x&j-uw4*sxp*&#$4x)%(5x!0j=751bc3e7tv6$0'
...
WSGI_APPLICATION = 'dce_mngr.wsgi.application'
